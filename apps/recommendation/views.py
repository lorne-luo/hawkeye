...
class WeeklyRecommendationRedirectView(RedirectView):
...
class WeeklyRecommendationListView(FilterView, ListView):
    ...
    def get_context_data(self, *, object_list=None, **kwargs):
        week = self.get_query_week()
        first_week = WeeklyRecommendation.objects.all().order_by('week').first().week
        last_week = WeeklyRecommendation.objects.all().order_by('week').last().week
